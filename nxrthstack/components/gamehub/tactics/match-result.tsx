...
export function MatchResult({ match }: MatchResultProps) {
  ...
  return (
    <motion.div
      ...
      className="rounded-sm border-2 border-border bg-card p-6 tactics-card"
    >
      ...
      <motion.div
        ...
        className={cn(
          "text-center mb-6 py-3 rounded-sm",
          isWin ? "bg-green-500/10 border border-green-500/30" : "bg-red-500/10 border border-red-500/30"
        )}
      >
        <h2 className={cn("text-2xl font-bold tactics-heading", isWin ? "text-green-400" : "text-red-400")}>
      ...
      {/* Rating Change */}
      <div className="flex items-center justify-center gap-4 mb-4 py-3 rounded-sm bg-background">
      ...
      {/* Currency Earned */}
      <div className="flex items-center justify-center gap-2 mb-4 py-2 rounded-sm bg-yellow-500/10 border-2 border-yellow-500/20">
      ...
      <div className="flex gap-3">
        <Link
          ...
          className="flex-1 flex items-center justify-center gap-2 rounded-sm bg-primary px-4 py-2.5 text-sm font-medium text-primary-foreground transition-colors hover:bg-primary/90 tactics-button tactics-button-primary"
        >
